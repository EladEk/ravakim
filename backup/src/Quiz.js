...
function Quiz({ sheetData, setQuizStarted, setCategory, setSelectedSheet, setSheetData, categoryProgress, setCategoryProgress, category, currentRowIndex, setCurrentRowIndex }) {
    ...
    <div className="quiz-container">
      <div className="quiz-title">
        ...
        <div className="quiz-title-text">
          {sheetData[currentQuestionIndex][0]}
        </div>
      </div>
      ...
      {isAnswerCorrect === false && (
        <div className="correct-answer">
          {constants.CorrectAnswer} {sheetData[currentQuestionIndex][5]}
        </div>
      )}      
      <div>
        <h3 className={`timer ${timeLeft <= 10 ? 'warning' : ''}`}>{constants.timeLeftText} {timeLeft} {constants.secondsText}</h3>
      </div>
